...
describe('Elastic DB', () => {
  ...
  describe('createIndex', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.createIndex(config.get('/elastic'), {}))
  ...
  describe('getAllIndex', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.getAllIndex(config.get('/elastic'), {}))
        .to.haveOwnProperty('err').equal('failed to create index, fail');
    });
    it('should return wrapper success', async () => {
      elastic.returns({
  ...
  describe('insertData', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.insertData(config.get('/elastic'), {}))
        .to.haveOwnProperty('err').equal('failed to create index, fail');
    });
    it('should return wrapper success', async () => {
      elastic.returns({
      ...
      expect(await helperElastic.insertData(config.get('/elastic'), { body: { _id: 1 } }))
        .to.haveOwnProperty('data').equal('success');
    });
  });
  ...
  describe('countData', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.countData(config.get('/elastic'), {}))
  ...
  describe('deleteData', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.deleteData(config.get('/elastic'), {}))
  ...
  describe('updateData', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.updateData(config.get('/elastic'), {}))
  ...
  describe('clearScroll', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.clearScroll(config.get('/elastic'), {}))
  ...
  describe('sugesters', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.sugesters(config.get('/elastic'), {}))
    ...
    it('should return wrapper success', async () => {
      ...
      const res = await helperElastic.sugesters(config.get('/elastic'), {});
  ...
  describe('findAll', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.findAll(config.get('/elastic'), {}))
        .to.haveOwnProperty('err').equal('failed to find data, fail');
    });
    it('should return wrapper success', async () => {
      let data = {
      ...
      const res = await helperElastic.findAll(config.get('/elastic'), {});
      expect(res.data[0]).to.equal('success');
    });
  ...
  describe('findOne', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.findOne(config.get('/elastic'), {}))
        .to.haveOwnProperty('err').equal('failed to find data, fail');
    });
    it('should return wrapper success', async () => {
      let data = {
      ...
      const res = await helperElastic.findOne(config.get('/elastic'), {});
  ...
  describe('insertMany', () => {
    it('should return wrapper error', async () => {
      expect(await helperElastic.insertMany(config.get('/elastic'), {}))
